      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 md:pt-12">
        ...
        <div class="grid md:grid-cols-12 gap-8 md:gap-10 items-start">
          ...
          <div class="md:col-span-4 flex md:block justify-center">
            <img src="assets/images/8F5YX8CKJS-20180613-150311.png" alt="Our representative" class="w-60 sm:w-72 md:w-[20rem] h-auto object-contain drop-shadow" />
          </div>
        ...
        <div class="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
          <img src="assets/images/about/1.jpg" alt="Gallery 1" class="w-full h-auto rounded shadow object-cover">
          <img src="assets/images/about/2.jpg" alt="Gallery 2" class="w-full h-auto rounded shadow object-cover">
          <img src="assets/images/about/3.jpg" alt="Gallery 3" class="w-full h-auto rounded shadow object-cover">
        </div>
