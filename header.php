                ...
                <div class="h-28 flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-end w-full md:w-auto">
                        ...
                        <div class="hidden md:flex items-center gap-5 mb-2 px-3 py-1 rounded-md">
                            ...
                            <!-- Search toggle -->
                            <button id="searchToggle" type="button" aria-expanded="false" class="flex items-center gap-2 hover:opacity-90">
                                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-600 ">
                        ...
                        <!-- ABSOLUTE DROPDOWN: keeps other links untouched -->
                        <div id="searchPanel" class="absolute right-auto top-full mt-2 hidden z-40">
                            <div class="w-80 bg-white text-gray-700 border border-gray-200 rounded-lg shadow-lg p-3">
                            <form action="#" method="GET">
                                ...
                                <button type="submit" class="mt-2 w-full bg-red-600 text-white text-sm font-medium px-3 py-2 rounded hover:bg-red-700">
                                        Search
                                </button>
                            </form>
                            </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="hidden md:flex items-center gap-2 lg:gap-4">
                                ...
                                <div class="relative group">
                                    <button data-link="products.php" href="products.php" class="px-4 py-4 rounded nav-link flex items-center gap-1 text-gray-700 hover:text-red-600 is-active" aria-current="page">
                                        PRODUCTS
                            ...
                            <button id="menuBtn" class="md:hidden p-2 rounded hover:bg-gray-100" aria-label="Open menu" aria-expanded="false">
            ...
            <div id="mobilePanel" class="hidden md:hidden border-t border-gray-200 bg-white">
                <div class="px-4 py-3 space-y-1">
                    ...
                    <button id="mobileProductsBtn" class="w-full flex items-center justify-between px-3 py-3 rounded nav-link">
                        <span>PRODUCTS</span>
                        <svg id="mobileChevron" class="w-4 h-4 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
