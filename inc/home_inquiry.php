  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
    <div class="grid md:grid-cols-12 gap-8 md:gap-10 items-center">
      ...
      <div class="md:col-span-7 text-white">
        ...
        <form id="inquiryForm" class="space-y-4" enctype="multipart/form-data">
          ...
          <div class="pt-2 flex justify-between">    
            <button id="submitBtn" type="submit" class="px-8 py-3 bg-black text-white font-semibold tracking-wide uppercase hover:bg-neutral-900 transition">
                Submit
            </button>
            <div>
                <label for="attachment" class="block mb-1">Attachment (optional)</label>
                <input id="attachment" name="attachment" type="file" class="block text-sm text-gray-900 bg-white border-2 border-gray-400 file:mr-4 file:py-2 file:px-4 file:border-0 file:bg-black file:text-white file:uppercase file:tracking-wide hover:file:bg-neutral-900">
            </div>
          </div>
        </form>
      </div>
